...
export const timeSlice = createSlice({
  ...
  reducers: {
    ...
    updateSelectedTag(state, action: PayloadAction<string>) {
      state.selectedTag = action.payload;
    },
    updateTextLog(state, action: PayloadAction<TextLogResponse>) {
      state.textLog = action.payload;
    },
    updateCombineTags(state, action: PayloadAction<boolean>) {
      state.combineTags = action.payload;
    },
...
export const selectSelectedTag = (state: RootState) => state.time.selectedTag;
...
export const selectCombineTags = (state: RootState) => state.time.combineTags;
